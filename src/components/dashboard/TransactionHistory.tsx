  ...
  return (
    <div className="px-[16px]">
      <div className="w-full">
        <div className="text-[14px] rounded bg-[#056dae]/10 p-2 w-full font-[500] flex items-center justify-between">
          <span>Recent Transactions</span>
          {hasTransactions && (
            <Link href="/dashboard/transactions" className="text-[13px] font-[500] text-[#056dae]">
              See More
            </Link>
          )}
        </div>
            ...
            transactionsToShow.map((transaction: Transaction) => (
              <div key={transaction.transaction_id} className="flex justify-between py-3">
                <div className="flex gap-2 text-gray-800">
                  <button className="border-none flex items-center justify-center outline-none rounded-full w-[35px] h-[35px] bg-[#056dae]/10">
