    ...
    <div className="w-full">
      ...
      <div className={`fixed z-20 w-full top-0 right-0 left-0 ${isModalOpen ? 'block' : 'hidden'}`}>
        <div className="bg-white rounded shadow-lg w-full h-screen">
          <div className="bg-[#056dae] text-[#ffffff] sticky top-0 z-10 p-3 py-5 flex items-center justify-between gap-1">
          ...
          <div className="relative p-4">
            <FiSearch className="absolute text-[#056dae] text-2xl left-[28px] top-[42px]" />
            <input
              type="text"
            ...
            <div className="max-h-[500px] py-4 border rounded-lg shadow-sm overflow-y-auto">
              {filteredBanks.map(bks => (
                <div
                  ...
                  className="flex px-4 gap-2 items-center p-2 cursor-pointer hover:bg-[#056dae]/10"
                >
